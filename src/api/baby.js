...
export default {
  getChilds (user_id, callback) {
    ...
    Vue.http
    .post(api.API_PATH_USER_GET_CHILD, {user_id})
  ...
  addChild ({commit}, data, resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_ADD_CHILD, data)
    .then(success, failure)
  ...
  removeChild ({commit}, data, resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_REMOVE_CHILD, data )
    .then(success, failure)
  ...
  modifyChild ({commit}, data, resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_MODIFY_CHILD, data )
    .then(success, failure)
