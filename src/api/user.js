...
export default {
  register ({commit}, data, resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_REGIST, JSON.parse(JSON.stringify(data)))
  ...
  signIn ({commit}, data, resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_LOGIN, JSON.parse(JSON.stringify(data)))
    .then(success, failure)
  },
  ...
  modifyMobile ( {commit}, data , resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_MODIFY_PHONE, data)
    .then(success, failure)
  },
  modifyAvatar ( {commit}, data , resolve, reject ) {
      ...
      Vue.http
      .post(api.API_PATH_USER_UPLOAD_AVATAR, data)
      .then(success, failure)
  },
  modifyInfo ( {commit}, data , resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_MODIFY_INFO, data)
    .then(success, failure)
  },
  modifyPassword ({commit}, data, resolve, reject) {
    ...
    Vue.http
    .post(api.API_PATH_USER_MODIFY_PASSWORD, JSON.parse(JSON.stringify(data)))
    .then(success, failure)
    // debug
    // setTimeout(()=>{
