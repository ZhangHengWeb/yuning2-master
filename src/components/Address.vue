	...
	<el-row :gutter='20' class='address'>
		...
		<el-col :xs='24' :span='7'>
			<el-form-item prop='district'>
				<el-select v-model='form.district' placeholder='请输入区' @change='districtChange'>
...
export default {
	...
	computed: {
		...
		districts: function() {
			// addressData[this.form.province][Object.keys(addressData[this.form.province])[0]][0]
			if (this.form.city!=='') {

				return formatData(addressData[this.form.province][this.form.city])
	...
	methods: {
		...
		cityChange: function(val, oldVal) {
			...
			var data = formatDistrictData(addressData[this.form.province][this.form.city])
			for (var i = 0; i < data.length; i++) {
				this.$set(this.districts, i, data[i])
			}
